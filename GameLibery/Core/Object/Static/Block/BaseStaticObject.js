...
(function (factory) {
    ...
    var BaseStaticObject = /** @class */ (function (_super) {
        ...
        function BaseStaticObject(name, objectVisual, position, objectType) {
        ...
        BaseStaticObject.prototype.Create = function () {
            ...
            ObjectUtility_1.ObjectUtility.AddObjectAttribute(this.position, this.objectType);
        };
        return BaseStaticObject;
    }(GameObject_1.GameObject));
    exports.BaseStaticObject = BaseStaticObject;
});
//# sourceMappingURL=BaseStaticObject.js.map